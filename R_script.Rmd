...
#plot the number of RNA counts, and the number of different RNA for each cell (?)
...
print(incisor[["pca"]], dims = 1:5, nfeatures = 5) # 5 genes that explain the most the variability through 5 axes
